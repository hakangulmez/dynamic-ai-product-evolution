# SPEC-006 — Document Normalization
...
Convert source files to stable text and indexed passages.
...
Normalized documents and source passages.
...
- Round-trip source traceability
- No material text loss on gold fixtures
