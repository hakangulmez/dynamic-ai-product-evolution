# SPEC-011 — Task Role Classification
...
Classify task importance to the product.

## Inputs

Validated task and product observations.

## Outputs

Role labels with evidence and confidence.
...
- No role inferred from text length
