...
Enumerate all eligible SEC and official company sources for each firm-date.

## Inputs

Company registry and source policies.
...
- Official-source precision >= 0.98
- Temporal candidate recall audited on sentinel set
