...
Measure availability, breadth, and commercialization without conflation.

## Inputs

Task/product observations and scale evidence.

## Outputs

Separate scale components.
...
- No single broad claim fills all components
- Unknown rate reported
