"""Governed V6 route for the product-first Item 1 software-universe gate."""
...
__all__ = ["PILOT_V6_ROUTE", "require_pilot_run_v6", "run_lineage_classifier_pilot_v6"]

PILOT_V6_PROMPT_PATH = "prompts/discovery/software_universe_classifier_pilot.v5.md"
...
PILOT_V6_ROUTE = PilotRunRoute(
    run_kind="classifier_pilot_v6",
    records_filename="universe_classifier_pilot_v6_records.jsonl",
    manifest_filename="universe_classifier_pilot_v6_manifest.json",
    raw_responses_filename="universe_classifier_pilot_v6_raw_responses.jsonl",
    manifest_contract="universe_classifier_pilot_manifest@0.6.0",
    manifest_schema="schemas/universe_classifier_pilot_manifest.v6.schema.json",
    authorization_contract="universe_classifier_pilot_authorization@0.6.0",
    authorization_schema="schemas/universe_classifier_pilot_authorization.v6.schema.json",
    run_root_name="universe-classifier-pilot-v6-runs",
    ...
    prompt_path=PILOT_V6_PROMPT_PATH,
...
def run_lineage_classifier_pilot_v6(
    *, repo_root: str | Path, cohort_manifest_path: str | Path,
    ...
    return _run_lineage_classifier_pilot(
        route=PILOT_V6_ROUTE, repo_root=repo_root,
...
def require_pilot_run_v6(run_dir: str | Path) -> Path:
    return _require_pilot_run(run_dir, route=PILOT_V6_ROUTE)
