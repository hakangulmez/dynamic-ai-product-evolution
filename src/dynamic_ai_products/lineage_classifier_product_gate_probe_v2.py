"""Governed execution route for the fixed five-filing financial-delivery wording probe."""
...
__all__ = [
    "PRODUCT_GATE_PROBE_V2_ROUTE",
    "require_product_gate_probe_run_v2",
    "run_product_gate_probe_v2",
]
...
PRODUCT_GATE_PROBE_V2_ROUTE = PilotRunRoute(
    run_kind="classifier_product_gate_probe_v2",
    records_filename="universe_classifier_product_gate_probe_v2_records.jsonl",
    manifest_filename="universe_classifier_product_gate_probe_v2_manifest.json",
    raw_responses_filename="universe_classifier_product_gate_probe_v2_raw_responses.jsonl",
    manifest_contract="universe_classifier_product_gate_probe_manifest@0.2.0",
    manifest_schema="schemas/universe_classifier_product_gate_probe_manifest.v2.schema.json",
    authorization_contract="universe_classifier_product_gate_probe_authorization@0.2.0",
    authorization_schema="schemas/universe_classifier_product_gate_probe_authorization.v2.schema.json",
    run_root_name="universe-classifier-product-gate-probe-v2-runs",
    ...
    prompt_path="prompts/discovery/software_universe_classifier_pilot.v8.md",
...
def run_product_gate_probe_v2(
    *, repo_root: str | Path, cohort_manifest_path: str | Path,
    ...
    return _run_lineage_classifier_pilot(
        route=PRODUCT_GATE_PROBE_V2_ROUTE,
        repo_root=repo_root,
...
def require_product_gate_probe_run_v2(run_dir: str | Path) -> Path:
    return _require_pilot_run(run_dir, route=PRODUCT_GATE_PROBE_V2_ROUTE)
