"""Governed V7 route for the product-first Item 1 software-universe gate."""
...
__all__ = ["PILOT_V7_ROUTE", "require_pilot_run_v7", "run_lineage_classifier_pilot_v7"]

PILOT_V7_PROMPT_PATH = "prompts/discovery/software_universe_classifier_pilot.v6.md"
...
PILOT_V7_ROUTE = PilotRunRoute(
    run_kind="classifier_pilot_v7",
    records_filename="universe_classifier_pilot_v7_records.jsonl",
    manifest_filename="universe_classifier_pilot_v7_manifest.json",
    raw_responses_filename="universe_classifier_pilot_v7_raw_responses.jsonl",
    manifest_contract="universe_classifier_pilot_manifest@0.7.0",
    manifest_schema="schemas/universe_classifier_pilot_manifest.v7.schema.json",
    authorization_contract="universe_classifier_pilot_authorization@0.7.0",
    authorization_schema="schemas/universe_classifier_pilot_authorization.v7.schema.json",
    run_root_name="universe-classifier-pilot-v7-runs",
    ...
    prompt_path=PILOT_V7_PROMPT_PATH,
...
def run_lineage_classifier_pilot_v7(
    *, repo_root: str | Path, cohort_manifest_path: str | Path,
    ...
    return _run_lineage_classifier_pilot(
        route=PILOT_V7_ROUTE, repo_root=repo_root,
...
def require_pilot_run_v7(run_dir: str | Path) -> Path:
    return _require_pilot_run(run_dir, route=PILOT_V7_ROUTE)
