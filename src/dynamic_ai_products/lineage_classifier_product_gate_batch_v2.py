"""Governed V2 execution route for one 100-row product-gate batch.
...
__all__ = ["PRODUCT_GATE_BATCH_V2_ROUTE", "require_product_gate_batch_run_v2", "run_product_gate_batch_v2"]
...
PRODUCT_GATE_BATCH_V2_ROUTE = PilotRunRoute(
    run_kind="classifier_product_gate_batch_v2",
    records_filename="universe_classifier_product_gate_batch_v2_records.jsonl",
    manifest_filename="universe_classifier_product_gate_batch_v2_manifest.json",
    raw_responses_filename="universe_classifier_product_gate_batch_v2_raw_responses.jsonl",
    manifest_contract="universe_classifier_product_gate_batch_manifest@0.2.0",
    manifest_schema="schemas/universe_classifier_product_gate_batch_manifest.v2.schema.json",
    authorization_contract="universe_classifier_product_gate_batch_authorization@0.2.0",
    authorization_schema="schemas/universe_classifier_product_gate_batch_authorization.v2.schema.json",
    run_root_name="universe-classifier-product-gate-batch-v2-runs",
    ...
    prompt_path="prompts/discovery/software_universe_classifier_pilot.v6.md",
...
def run_product_gate_batch_v2(
    *, repo_root: str | Path, cohort_manifest_path: str | Path,
    ...
    return _run_lineage_classifier_pilot(
        route=PRODUCT_GATE_BATCH_V2_ROUTE, repo_root=repo_root,
...
def require_product_gate_batch_run_v2(run_dir: str | Path) -> Path:
    return _require_pilot_run(run_dir, route=PRODUCT_GATE_BATCH_V2_ROUTE)
