"""Governed execution route for the fixed five-filing software-product probe."""
...
__all__ = [
    "PRODUCT_GATE_PROBE_V1_ROUTE",
    "require_product_gate_probe_run_v1",
    "run_product_gate_probe_v1",
]
...
PRODUCT_GATE_PROBE_V1_ROUTE = PilotRunRoute(
    run_kind="classifier_product_gate_probe_v1",
    records_filename="universe_classifier_product_gate_probe_records.jsonl",
    manifest_filename="universe_classifier_product_gate_probe_manifest.json",
    raw_responses_filename="universe_classifier_product_gate_probe_raw_responses.jsonl",
    manifest_contract="universe_classifier_product_gate_probe_manifest@0.1.0",
    manifest_schema="schemas/universe_classifier_product_gate_probe_manifest.v1.schema.json",
    authorization_contract="universe_classifier_product_gate_probe_authorization@0.1.0",
    authorization_schema="schemas/universe_classifier_product_gate_probe_authorization.v1.schema.json",
    run_root_name="universe-classifier-product-gate-probe-v1-runs",
    ...
    prompt_path="prompts/discovery/software_universe_classifier_pilot.v7.md",
...
def run_product_gate_probe_v1(
    *, repo_root: str | Path, cohort_manifest_path: str | Path,
    ...
    return _run_lineage_classifier_pilot(
        route=PRODUCT_GATE_PROBE_V1_ROUTE,
        repo_root=repo_root,
...
def require_product_gate_probe_run_v1(run_dir: str | Path) -> Path:
    return _require_pilot_run(run_dir, route=PRODUCT_GATE_PROBE_V1_ROUTE)
