...
A financial product, payment service, account, loan, card, brokerage,
insurance product, or payment network is not itself a software product merely
because customers access it digitally. Count it only where Item 1 establishes
