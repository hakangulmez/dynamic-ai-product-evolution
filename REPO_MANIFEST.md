...
Total tracked/scaffold files listed: **1096**
...
- `prompts/discovery/software_universe_classifier_pilot.v5.md`
...
- `schemas/universe_classifier_pilot_authorization.v6.schema.json`
- `schemas/universe_classifier_pilot_authorization.v7.schema.json`
...
- `schemas/universe_classifier_pilot_manifest.v6.schema.json`
- `schemas/universe_classifier_pilot_manifest.v7.schema.json`
...
- `schemas/universe_classifier_product_gate_semantic_probe_authorization.v2.schema.json`
- `schemas/universe_classifier_product_gate_semantic_probe_manifest.v1.schema.json`
- `schemas/universe_classifier_product_gate_semantic_probe_manifest.v2.schema.json`
...
- `schemas/universe_classifier_authorization.v3.schema.json`
...
- `schemas/universe_classifier_axes_record.v3.schema.json`
- `schemas/universe_classifier_record.v3.schema.json`
- `schemas/universe_classifier_authorization.v4.schema.json`
...
- `schemas/universe_classifier_authorization.v9.schema.json`
...
- `src/dynamic_ai_products/lineage_classifier_pilot_v6.py`
...
- `src/dynamic_ai_products/lineage_classifier_product_gate_semantic_probe_v2.py`
...
- `src/dynamic_ai_products/providers/vertex_gemini_screen_v6.py`
...
- `tests/universe/test_classifier_pilot_v5_prompt.py`
- `tests/universe/test_classifier_pilot_v6_prompt.py`
